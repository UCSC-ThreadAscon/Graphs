...
_, stdsWakeupDict = getStds()
print(stdsWakeupDict)

def linegraph():
  aes = stdsWakeupDict['AES'].values()
  asconaead128 = stdsWakeupDict["AsconAead128"].values()
  noencrypt = stdsWakeupDict["No Encryption"].values()
